...
const TRANSLATIONS = {
  en: {
    ...
    "rfp.prog1": "Modules & Type", "rfp.prog2": "Description", "rfp.prog3": "Attachment", "rfp.prog4": "Review",
    "rfp.s1.title": "Request Title & SAP Module",
    "rfp.s1.sub": "Select all that apply. Multiple selections are allowed.",
    "rfp.titleLabel": "Request Title", "rfp.titlePlaceholder": "e.g. Sales Order Upload from Excel",
  ...
  ko: {
    ...
    "rfp.prog1": "모듈 & 유형", "rfp.prog2": "요구사항", "rfp.prog3": "파일첨부", "rfp.prog4": "검토",
    "rfp.s1.title": "요청 제목 & SAP 모듈",
    "rfp.s1.sub": "해당하는 항목을 모두 선택하세요. 복수 선택 가능합니다.",
    "rfp.titleLabel": "요청 제목", "rfp.titlePlaceholder": "예) 엑셀 파일로 판매오더(SO) 대량 생성 프로그램",
    ...
    "rfp.descPlaceholder": "예시: 엑셀 파일에서 판매오더를 일괄 생성하는 프로그램이 필요합니다. 엑셀에는 오더 유형, 고객 코드, 자재 번호, 수량, 납기일이 포함됩니다. 각 행의 유효성을 검사하고 오류는 ALV로 표시하며 정상 데이터는 BAPI로 SO를 생성해야 합니다...",
