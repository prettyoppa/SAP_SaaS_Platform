...
const TRANSLATIONS = {
  en: {
    ...
    "hub.deleteRfpConfirm": "Delete this new-development request? Attachments, interview, proposal, FS, and delivery records will be permanently removed. Links from analysis/integration screens will be cleared but those records stay.",
  ...
  ko: {
    ...
    "home.anonymous": "익명",
    "hub.deleteRfpConfirm": "이 신규 개발 요청을 삭제할까요? 첨부·인터뷰·제안·FS·납품 기록이 함께 삭제되며 되돌릴 수 없습니다. 분석/연동 화면에 연결만 해제되고 해당 요청 자체는 유지됩니다.",
